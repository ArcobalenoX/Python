...
from utils import get_class_name, plot_image
...
train_db = RSdataset(r'E:\Code\Python\datas\selfWHURS\WHURS19', 300, mode='train')
val_db = RSdataset(r'E:\Code\Python\datas\selfWHURS\WHURS19', 300, mode='val')
test_db = RSdataset(r'E:\Code\Python\datas\selfWHURS\WHURS19', 300, mode='test')
...
if __name__ == '__main__':
    train_val()
    #test()
    test_single_image(r'E:\Code\Python\datas\selfWHURS\WHURS19\Mountain\Mountain_50.jpg')
