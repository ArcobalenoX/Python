...
def cv_show(name, image):
    ...
    #cv2.resizeWindow(name, 1084, 398)
...
if __name__ =="__main__":
    ...
    stich_result = stich(imageA, imageB, M)

    cv_show("stich_result", stich_result)

    # 绘制匹配结果
    drawImg = drawMatches(imageA, imageB, kpsA, kpsB, matches, status)
    cv_show("drawImg", stich_result)
